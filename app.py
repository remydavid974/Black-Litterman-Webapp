...
with tab1:
    ...
    - 🧪 The final portfolio includes **realistic features**: transaction costs, volatility controls, and out-of-sample testing.
    ...
    with st.expander("🔬 More Details: How the Strategy is Built"):
        ...
        st.markdown("""
                    ...
                    - Instead, the strategy anchors the forecast on the **Black-Litterman implied return** \\(μ<sub>implied</sub>), and then applies a **signal-based adjustment**:""",
        ...
        st.markdown("### 🧩 **Black-Litterman Inputs**")
        st.markdown("""
